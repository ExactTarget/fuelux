	...
	if($.fn.repeater){
		$.fn.repeater.viewTypes.list = {
			...
			initialize: function(helpers, callback){
				console.log('initialize: ', helpers);
				callback();
			},
			resize: function(helpers){
				console.log('resize: ', helpers);
			},
			selected: function(helpers){
				console.log('selected: ', helpers);
			},

			before: function(helpers){
				console.log('before: ', helpers);
				return { item: '<div>before</div><div data-container="true"></div>' };
			},
			renderItem: function(helpers){
				console.log('renderItem: ', helpers);
				return { item: '<div>item</div>' };
			},
			after: function(helpers){
				console.log('after: ', helpers);
				return { item: '<div>after</div>', action: 'prepend', container: helpers.container.find('[data-container="true"]') };
			}//,
			//repeat: 'data.items'//,
