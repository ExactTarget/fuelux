...
define(function(require){
	...
	asyncTest("should handle multiple row selection", function () {
		...
		var $datagrid = $(this.datagridHTML).datagrid({
			...
			$datarows.eq(0).click();
			equal($datarows.eq(0).hasClass('selected'), true, 'the first selected row has the "selected" class applied');
			equal(Object.keys($datagrid.datagrid('getSelectedItems')).length, 1, 'the datagrid has only one row selected');
			...
			$datarows.eq(2).click();
			equal($datarows.eq(0).hasClass('selected'), true, 'the first row has the "selected" class applied');
			equal($datarows.eq(2).hasClass('selected'), true, 'the third row has the "selected" class applied');
			...
			$datarows.eq(2).click();
			equal($datarows.eq(0).hasClass('selected'), true, 'the first row has the "selected" class applied');
			equal($datarows.eq(2).hasClass('selected'), false, 'the third row no longer has the "selected" class applied');
			...
			// one row selected.
			$datarows.eq(0).click();
			equal($datarows.eq(0).hasClass('selected'), false, 'the first row no longer has the "selected" class applied');
			equal($datarows.eq(2).hasClass('selected'), true, 'the third row has the "selected" class applied');
			equal(Object.keys($datagrid.datagrid('getSelectedItems')).length, 1, 'the datagrid has only one row selected');
