...
define(function repeaterTests (require) {
	var $ = require('jquery');
	...
	test('should be defined on jquery object', function jqueryObject () {
		ok($().repeater, 'repeater method is defined');
	});

	test('should return element', function returnElement () {
		var $repeater = $(this.$markup);
		ok($repeater.repeater() === $repeater, 'repeater should be initialized');
	});

	test('should call dataSource correctly', function callDatasource () {
		var $repeater = $(this.$markup);
		$repeater.repeater({
			dataSource: function dataSource (options, callback) {
				ok(true, 'dataSource function called prior to rendering');
	...
	test('should handle filtering correctly', function filtering () {
		...
		$repeater.repeater({
			dataSource: function dataSource (options, callback) {
				if (hasCalledDS) {
					ok(true, 'dataSource called again upon selecting different filter');
	...
	test('should handle itemization correctly', function itemization () {
		var hasCalledDS = false;
		var $repeater = $(this.$markup);
		...
		$repeater.repeater({
			dataSource: function dataSource (options, callback) {
				if (hasCalledDS) {
					ok(true, 'dataSource called again upon selecting different page size');
	...
	test('should handle pagination correctly', function pagination () {
		var count = -1;
		var $repeater = $(this.$markup);
		...
		$repeater.repeater({
			dataSource: function dataSource (options, callback) {
				...
				case 0:
					...
					break;
				case 1:
					ok(true, 'dataSource called again upon clicking next button');
					...
					break;
				case 2:
					ok(true, 'dataSource called again upon clicking prev button');
	...
	test('should handle search correctly', function search () {
		var count = -1;
		var $repeater = $(this.$markup);
	...
	test('should handle canceling search correctly', function cancelSearch () {
		var count = -1;
		var $repeater = $(this.$markup);
		var $search = $repeater.find('.repeater-search');
		$repeater.repeater({
	...
	test('should handle views correctly', function views () {
		var hasCalledDS = false;
		var $repeater = $(this.$markup);
	...
	test('should run view plugin aspects correctly - pt 1', function viewTypes () {
		var ran = 0;
		var $repeater = $(this.$markup);
	...
	test('should run view plugin aspects correctly - pt 2', function viewTypes2 () {
		var $repeater = $(this.$markup);
		$.fn.repeater.viewTypes.test1 = {
	...
	test('views config option should function as expected', function configOption () {
		var $repeater = $(this.$markup);
		var $views = $repeater.find('.repeater-views');
		$repeater.repeater({
			views: {
	...
	test('should handle disable / enable correctly', function enableDisable () {
		var $repeater = $(this.$markup);
		...
		$repeater.on('disabled.fu.repeater', function disabled () {
			ok(true, 'disabled event called as expected');
		});

		$repeater.on('enabled.fu.repeater', function enabled () {
			ok(true, 'enabled event called as expected');
		});
