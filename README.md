**Please note:** Fuel UX 2.x is depreciated. While we will still maintain it (bug fixes only), we suggest looking at FuelUX 3.0. Version 3 is a major overhaul and is built atop of Bootstrap 3.
